...
>
  <div style={{ flex: 1 }}>
    John is a Senior Engineer at <strong>Legend</strong>, working on the platform behind
    <strong> Casino.org</strong>. We sat down to discuss how Axolo changed their pull‑request workflow
    across five squads, cutting review delays and reducing Slack noise.
  </div>
</div>
...
Legend’s product team has ~30 engineers organized into five squads, collaborating with a wider group of ~60 engineers for cross‑cutting initiatives. Day‑to‑day work happens within squads; larger architecture and long‑term planning involve the broader group. Their goal each week: collaborate well, avoid incidents, and show real progress — ideally faster than planned.
