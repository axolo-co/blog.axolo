...
Our advice would be to use a specialized solution such as [conv.ly](https://conv.ly), which provides a seamless experience between Slack and Teams. Setup takes only a few clicks, allowing Slack users to manage Teams messages directly from Slack without ever opening Teams ever again for chatting 😀.
